...
`dotspacemacs/user-config' first."
  (setenv "PATH" (concat (getenv "PATH") ":/Users/rkapitonov/.nvm/versions/node/v8.2.1/bin"))
  (setq exec-path (append exec-path '("/Users/rkapitonov/.nvm/versions/node/v8.2.1/bin")))
  )
